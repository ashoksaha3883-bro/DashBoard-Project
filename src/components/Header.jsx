...
const Header = ({ addItem }) => {
  ...
  return (
    <>
      <div className="flex justify-between items-center p-4 bg-white shadow-sm rounded-t-xl">
        <h5 className="text-lg font-semibold">{t('ofspace')}</h5>
      ...
      {showModal2 && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            <h2 className="text-xl font-bold mb-4">{t('Add your Items')}</h2>
